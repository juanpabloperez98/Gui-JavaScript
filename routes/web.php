...
// DOM
Route::prefix('DOM/')->group(function () {
    Route::get('index/', function () {
        return view('teoria.dom.index', [
            'page' => 'dom'
        ]);
    })->name('dom');
    ...
    Route::get('html/', function () {
        return view('teoria.dom.html.index', [
            'page' => 'html'
        ]);
    })->name('html');

    Route::get('html/ejemplos', function () {
        return view('teoria.dom.html.ejemplos.ejemplos_index', [
            'page' => 'html-ejemplos-index'
        ]);
