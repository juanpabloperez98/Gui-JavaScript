        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                @switch($page)
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dom') }}">
                            <img src="{{ asset('imagenes/icons/icon-next.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Siguiente
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('css') }}">
                            <img src="{{ asset('imagenes/icons/icon-next.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Siguiente
                        </a>
                    ...
                    @break
                    @case('html-ejemplos-index')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('DOM/html#ejemplos') }}">
                            <img src="{{ asset('imagenes/icons/icon-back.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Volver
                        </a>
                    ...
                    @case('html-ejemplos')
                    <li class="nav-item"> 
                        <a class="nav-link" href="{{ route('html-ejemplo-index') }}">
                            <img src="{{ asset('imagenes/icons/icon-back.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Volver
                        </a>
                    ...
                    @break
                    @case('css-ejemplos-index')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('DOM/css#ejemplos') }}">
                            <img src="{{ asset('imagenes/icons/icon-back.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Volver
                        </a>
                    ...
                    @case('css-ejemplos')
                    <li class="nav-item"> 
                        <a class="nav-link" href="{{ route('css-ejemplo-index') }}">
                            <img src="{{ asset('imagenes/icons/icon-back.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Volver
                        </a>
                    ...
                    @break
                    @case('js-ejemplos-index')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('DOM/js#ejemplos') }}">
                            <img src="{{ asset('imagenes/icons/icon-back.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Volver
                        </a>
                    ...
                    @case('js-ejemplos')
                    <li class="nav-item"> 
                        <a class="nav-link" href="{{ route('js-ejemplo-index') }}">
                            <img src="{{ asset('imagenes/icons/icon-back.png') }}" alt="icon-back"
                                style="width: 20px; margin: 0px 5px 0px 0px">
                            Volver
                        </a>
