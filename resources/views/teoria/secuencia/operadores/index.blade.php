...
@section('content')
    <main id="tp-main">
        ...
        <div class="row mx-auto p-md-4" id="ejercicios">
            <div class="col-lg-11 text-center mx-auto bg-light columna-principal">
                <h4 class="text-center mb-md-5 font-weight-bold">Ejercicios</h4>
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="card-personalizada">
                            ...
                            <div class="cardboton">
                                <a href="{{ route('operadores-ejercicio1') }}" class="btn">Ir al ejemplo</a>
                            </div>
                        </div>
                      </div>
                      <div class="carousel-item">
                        <div class="card-personalizada">
                            ...
                            <div class="cardboton">
                                <a href="#" class="btn">Ir al ejemplo</a>
                            </div>
                        </div>
                      </div>
                      <div class="carousel-item">
