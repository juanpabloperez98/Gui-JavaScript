   ...
   &lt;/html&gt;
    ...
    &lt;/html&gt;
            ...
            <div class="col-lg-5 mx-auto mt-3 bg-light columna-principal">
                ...
                <p class="mt-3">
                    Bueno, ya se entiendo bien para que se usa el atributo id, pero ahora supóngase que se necesita identificar varias etiquetas que van a compartir un mismo evento o un mismo estilo (Por estilo se hace referencia a CSS que en la siguiente sección se va a tratar mejor), entonces ¿Cómo se haría para poder identificar varias etiquetas que van a compartir un mismo estilo?, bueno es sencillo, a través del atributo class, se puede identificar varias etiquetas, por lo que puede repetirse una o varías clases en varias etiquetas
                </p>
            </div>
        </div>
